...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _showOtpModalPopup() {
    showDialog(
      ...
      builder: (dialogCtx) => _OtpDialogWidget(
...
// ==========================================
// POPUP XÁC THỰC MÃ OTP & RESEND (MODAL)
// ==========================================
...
class _OtpDialogWidgetState extends State<_OtpDialogWidget> {
  ...
  int _otpCountdown = 60; // Sống trong 60 giây
  Timer? _otpTimer;
  ...
  void _sendOtp() {
    ...
    // Bật thông báo đẩy góc trên bên phải
    TopSyncToast.show(
      context,
  ...
  Future<void> _verifyOtpAndRegister() async {
    ...
    // Mã OTP chính xác -> Tạo tài khoản chính thức
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // NÚT GỬI LẠI MÃ RESEND (Chỉ bấm được sau 60s)
              TextButton(
